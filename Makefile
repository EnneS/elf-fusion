...
am__depfiles_remade = ./$(DEPDIR)/ARM_runner_example.Po \
	./$(DEPDIR)/affichage_elf.Po \
	./$(DEPDIR)/affichage_executable.Po \
	./$(DEPDIR)/arm_simulator_interface.Po ./$(DEPDIR)/csapp.Po \
	./$(DEPDIR)/debug.Po ./$(DEPDIR)/elf_file.Po \
	./$(DEPDIR)/elf_file_reverse.Po ./$(DEPDIR)/elf_fusion.Po \
	./$(DEPDIR)/elf_reader.Po ./$(DEPDIR)/fusion.Po \
	./$(DEPDIR)/gdb_protocol.Po ./$(DEPDIR)/hashtable.Po \
...
ACLOCAL = ${SHELL} /home/cleo/Documents/Cours/Grenoble/Prog5/projet/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/cleo/Documents/Cours/Grenoble/Prog5/projet/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/cleo/Documents/Cours/Grenoble/Prog5/projet/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/cleo/Documents/Cours/Grenoble/Prog5/projet/build-aux/missing automake-1.16
AWK = mawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/cleo/Documents/Cours/Grenoble/Prog5/projet/build-aux/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = elf_linker
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/cleo/Documents/Cours/Grenoble/Prog5/projet
abs_srcdir = /home/cleo/Documents/Cours/Grenoble/Prog5/projet
abs_top_builddir = /home/cleo/Documents/Cours/Grenoble/Prog5/projet
abs_top_srcdir = /home/cleo/Documents/Cours/Grenoble/Prog5/projet
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/cleo/Documents/Cours/Grenoble/Prog5/projet/build-aux/install-sh
...
include ./$(DEPDIR)/affichage_elf.Po # am--include-marker
include ./$(DEPDIR)/affichage_executable.Po # am--include-marker
...
include ./$(DEPDIR)/elf_file.Po # am--include-marker
include ./$(DEPDIR)/elf_file_reverse.Po # am--include-marker
include ./$(DEPDIR)/elf_fusion.Po # am--include-marker
include ./$(DEPDIR)/elf_reader.Po # am--include-marker
...
distclean: distclean-recursive
	...
	-rm -f ./$(DEPDIR)/affichage_elf.Po
	-rm -f ./$(DEPDIR)/affichage_executable.Po
	-rm -f ./$(DEPDIR)/arm_simulator_interface.Po
	-rm -f ./$(DEPDIR)/csapp.Po
	-rm -f ./$(DEPDIR)/debug.Po
	-rm -f ./$(DEPDIR)/elf_file.Po
	-rm -f ./$(DEPDIR)/elf_file_reverse.Po
	-rm -f ./$(DEPDIR)/elf_fusion.Po
	-rm -f ./$(DEPDIR)/elf_reader.Po
