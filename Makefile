...
am_affichage_executable_OBJECTS = $(am__objects_1) \
	...
	elf_file_reverse.$(OBJEXT) elf_writer.$(OBJEXT)
...
ACLOCAL = ${SHELL} /home/r/royetju/elf-fusion/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /home/r/royetju/elf-fusion/build-aux/missing automake-1.14
AWK = gawk
CC = gcc
...
include ./$(DEPDIR)/affichage_elf.Po
include ./$(DEPDIR)/affichage_executable.Po
